...
<html>
  ...
  <body>
    <div class="x-nav">
      <span class="layui-breadcrumb">
        ...
        <button type="button" onclick="location.href='${ctx}/page/dept/add.jsp'" class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:innert;margin-left:75%;;"  ><i class="layui-icon"></i>增加</button>
 ...
 <!--        <button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon"></i>批量删除</button> -->
     ...
     <tr>
            ...
            <td class="td-manage">
              <a title="编辑"   href="${ctx}/dept/updateDeptView?id=${dept.id }">
             
                <i class="layui-icon">&#xe642;</i>
              </a>
              <a title="删除" id="${dept.id}" class="delDept" href="javascript:;">
                <i class="layui-icon">&#xe640;</i>
              </a>
            </td>
          </tr>
