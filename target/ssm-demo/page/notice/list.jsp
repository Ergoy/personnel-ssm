...
<html>
  ...
  <body>
    <div class="x-nav">
      ...
      <button type="button" onclick="location.href='${ctx}/page/notice/add.jsp'" class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:innert;margin-left:75%;;"  ><i class="layui-icon"></i>增加</button>
 ...
 <!--        <button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon"></i>批量删除</button> -->
      ...
      <table class="layui-table">
        ...
        <tbody>
        <c:forEach items="${requestScope.noticeList}" var="notices" varStatus="stat">
     <tr>
            <td>
